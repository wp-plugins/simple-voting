...
class Shortcode_Processor___Simple_Voting {
	...
	public function show_voting_form( $atts, $content ) {
		...
		if( $voteSubject->isComplete() ) {
			...
			$userNameLabel = __("Your name:", "simple-voting");
			$userCommentLabel = __("Comments:", "simple-voting");
