...
form and each voting result the button with a title `You are admin. Check answers`. This button
will allow admins to see the list of all votes for this subject.
...
Such block of code could be placed in any article or page, and will rate the same “Arbitrary subject name”.
...
{db_prefix}simple_voting_subjects
{db_prefix}simple_voting_votes
